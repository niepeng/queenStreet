...
import com.baibutao.apps.queenstreet.activities.common.DownLoader;
import com.baibutao.apps.queenstreet.androidext.QueenStreetApplication;
import com.baibutao.apps.queenstreet.common.ProgressCallback;
import com.baibutao.apps.queenstreet.util.DateUtil;
...
public class UpdateClientActivity extends BaseActivity {
	...
	private void startDownLoad() {
		...
		downLoader.asyDownload((QueenStreetApplication) this.getApplication());
	...
	private void endMe() {
		try {
			...
			((QueenStreetApplication)this.getApplication()).finishAllActivities();
	...
	private static String genName() {
		return "youthday_install_file_" + DateUtil.format(new Date(), "yyyy_MM_dd_HH_mm") + ".apk";
	}
