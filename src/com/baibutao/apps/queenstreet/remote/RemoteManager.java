...
import com.baibutao.apps.queenstreet.remote.http.HttpRemoteManager;
import com.baibutao.apps.queenstreet.remote.proxy.AutoConnectRemoteManager;
import com.baibutao.apps.queenstreet.remote.proxy.CheckNetworkStateRemoteManager;
import com.baibutao.apps.queenstreet.remote.proxy.SecurityRemoteManager;
...
public abstract Request createQueryRequest(String target);
	...
	protected static QueenStreetApplication queenStreetApplication;
	
	private static RemoteManager defaultRemoteManager = new HttpRemoteManager();
	
	public static void init(QueenStreetApplication queenStreetApplication) {
		RemoteManager.queenStreetApplication = queenStreetApplication;
	}
	...
	public static RemoteManager getFullFeatureRemoteManager() {
		return new CheckNetworkStateRemoteManager(new AutoConnectRemoteManager(new SecurityRemoteManager(defaultRemoteManager), 3));
	}
